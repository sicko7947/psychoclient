...
func (rt *roundTripper) dialTLS(ctx context.Context, network, addr string) (net.Conn, error) {
	...
	rt.cachedConnections[addr] = tlsConn
...
func newRoundTripper(clientHello utls.ClientHelloID, specs utls.ClientHelloSpec, dialer ...proxy.ContextDialer) http.RoundTripper {
	if len(dialer) > 0 {
		return &roundTripper{
			dialer: dialer[0],
